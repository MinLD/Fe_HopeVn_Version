...
function CreatePost({ token }: CreatePostProps) {
  ...
  return (
    <>
      {isOpenCreatePost && (
        <div className="fixed inset-0 flex items-center justify-center p-1 z-50  ">
          <div
            className="absolute inset-0 z-50 bg-black opacity-60"
            onClick={() => setOpenCreatePost(false)}
          />
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[70vh] z-50 flex flex-col">
            {/* Header */}
            ...
            <form
              ...
              className="p-2 space-y-6 overflow-y-auto flex-grow"
            >
              {/* Basic Information */}
                  ...
                  <div>
                    ...
                    {formik.touched.content && formik.errors.content ? (
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Cung cấp thông tin rõ ràng và trung thực sẽ giúp bạn
                        nhận được sự hỗ trợ tốt hơn.
                      </p>
                    )}
                  </div>
                </div>
                ...
                <Card padding="none" className="p-2 sm:p-4">
                  ...
                  <div className="mt-4 p-3 bg-yellow-50 border-l-4 border-yellow-400 rounded-r-lg">
                    <p className="text-sm text-yellow-800">
                      <strong>Lưu ý:</strong> Thông tin này là bắt buộc và sẽ
                      được dùng để mọi người hỗ trợ bạn. Vui lòng kiểm tra kỹ.
                    </p>
                  </div>
                </Card>
              )}
            ...
            {/* Footer with Actions */}
            <div className="flex space-x-4 p-3 border-t border-gray-200 bg-gray-50 rounded-b-2xl">
              <button
                type="button"
                onClick={handleReset}
                className="flex-1 py-3 px-2 sm:px-4 border border-gray-300 text-gray-800 rounded-xl hover:bg-gray-100 transition-colors duration-200 font-semibold"
              >
                Hủy
              </button>
              <button
                ...
                className="flex justify-center items-center flex-1 py-3 px-2 sm:px-4 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition-colors duration-200 font-semibold shadow-md disabled:bg-emerald-300 disabled:cursor-not-allowed"
